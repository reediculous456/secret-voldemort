...
module.exports.ipbansNotEnforced = { status: true };
...
module.exports.formattedGameList = () => {
	return Object.keys(module.exports.games).map(gameName => ({
		...
		enactedOrderProclamationCount: games[gameName].trackState.orderProclamationCount,
		enactedDeathEaterProclamationCount: games[gameName].trackState.deathEaterProclamationCount,
