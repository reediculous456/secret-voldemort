module.exports.chatReplacements = [
	...
	},
	{
		...
		regex: /^mod.support/i,
		replacement:
			'The  most effective way to contact a mod is through our discord server in #mod-support. Join here:https://discord.gg/secretvoldemortio. Make sure to agree to our rules to access the channel. Once there, just ping @Moderator and explain the situation. Provide game links and images when possible.',
		aemCooldown: 15,
		normalCooldown: 180,
		normalGames: 50
	},
	...
	},
	{
		...
		regex: /^d.iscard/i,
		replacement:
			'When you are in a government you can either be the minister of magic or the headmaster. As the minister, you receive 3 cards and select a card you do NOT want to be played. As a headmaster, you get 2 cards and select the one you WANT to play.',
		aemCooldown: 15,
		normalCooldown: 180,
		normalGames: 50
	},
